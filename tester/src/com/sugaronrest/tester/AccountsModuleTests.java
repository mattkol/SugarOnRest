...
public class AccountsModuleTests {
    ...
    public static void crudTest() throws JsonProcessingException {
    ...
    public static void crudByTypeTest() throws JsonProcessingException {
        SugarRestClient client = new SugarRestClient(TestAccount.Url, TestAccount.Username, TestAccount.Password);
    ...
    public static void crudJDataTest() throws IOException {
        SugarRestClient client = new SugarRestClient(TestAccount.Url, TestAccount.Username, TestAccount.Password);
    ...
    public static void readBulkAccountTest() {
    ...
    public static void readAccountSelectFieldTest() throws IOException {
    ...
    public static void readPagedAccountTest() {
    ...
    public static void deleteGroupAccountTest() {
