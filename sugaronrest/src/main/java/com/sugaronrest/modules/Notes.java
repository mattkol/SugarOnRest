...
@Module(name = "Notes", tablename = "notes")
...
public class Notes {
    ...
    public Integer getPortalFlag() {
        return portalFlag;
    }

    public void setPortalFlag(Integer value) {
        portalFlag = value;
    }
    public Integer getEmbedFlag() {
        return embedFlag;
    }

    public void setEmbedFlag(Integer value) {
        embedFlag = value;
    }
    ...
    @JsonProperty("portal_flag")
    private Integer portalFlag;
  
    @JsonProperty("embed_flag")
    private Integer embedFlag;
